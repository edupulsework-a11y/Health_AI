...
class _SpecialistDashboardScreenState extends State<SpecialistDashboardScreen> {
  ...
  final double _totalEarnings = 1497.0; // Mock base + dynamic if possible
  final int _communitySteps = 45200;
  ...
  Future<void> _generateAndOpenPlan(BuildContext context, String name, String type) async {
    ...
    if (context.mounted) {
       ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Plan Anchored on MegaETH! Tx: ${txHash.substring(0, 10)}...'),
