...
class _DashboardScreenState extends State<DashboardScreen> {
    ...
    try {
      ...
      if (data != null && mounted) {
        final profile = UserData(
          ...
          accountType: (data['role'] == 'specialist' || data['role'] == 'professional') 
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if ((_currentUser ?? widget.user).isFemale || (_currentUser?.role == 'pregnant')) ...[
                    const SizedBox(height: 24),
                    _buildMaternityCard(context),
                    const SizedBox(height: 24),
  ...
  Widget _buildMaternityCard(BuildContext context) {
    return InkWell(
      onTap: () => Navigator.pushNamed(context, '/maternity'),
      borderRadius: BorderRadius.circular(20),
      child: Container(
        padding: const EdgeInsets.all(20),
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(20),
          boxShadow: [BoxShadow(color: Colors.pink.withOpacity(0.2), blurRadius: 8, offset: const Offset(0, 4))],
        ),
        child: const Row(
          children: [
            Icon(Icons.child_friendly_rounded, color: Colors.white, size: 32),
            SizedBox(width: 16),
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Maternity & Baby Bloom', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18)),
                  Text('Track pregnancy and baby health.', style: TextStyle(color: Colors.white70, fontSize: 13)),
                ],
              ),
            ),
