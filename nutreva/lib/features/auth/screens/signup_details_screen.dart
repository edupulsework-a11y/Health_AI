...
class SignupDetailsScreen extends StatefulWidget {
  final String role;
  const SignupDetailsScreen({super.key, required this.role});
...
class _SignupDetailsScreenState extends State<SignupDetailsScreen> {
  ...
  bool get isSpecialist => widget.role == 'professional';
  ...
  Future<void> _handleGoogleSignup() async {
    ...
    try {
      ...
      if (response != null && response.user != null) {
        ...
        final walletAddress = await Web3Service().createWallet();
        ...
        final profileData = {
          ...
          'role': widget.role,
          'specialization': isSpecialist ? _specialization : null,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(isSpecialist ? 'Specialist Details' : 'Your Details'),
      ),
      body: SafeArea(
