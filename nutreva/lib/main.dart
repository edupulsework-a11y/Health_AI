...
import 'features/menstrual/maternity_screen.dart';
...
// Mock data for initial routes (usually replaced by real data after login)
final mockUser = UserData(name: "User", email: "user@example.com", age: 25, gender: "Female", category: "Working Professional");
final mockSpecialist = UserData(name: "Dr. Smith", email: "smith@example.com", age: 35, gender: "Male", category: "Nutritionist", accountType: AccountType.specialist);
...
Future<void> main() async {
  ...
  await Firebase.initializeApp(
    options: const FirebaseOptions(
      apiKey: "AIzaSyCw3oJs8Xpm7kRBaWOvy03GYEBRg-rTMNg",
      authDomain: "esp82live.firebaseapp.com",
      databaseURL: "https://esp82live-default-rtdb.asia-southeast1.firebasedatabase.app",
      projectId: "esp82live",
      storageBucket: "esp82live.firebasestorage.app",
      messagingSenderId: "1017456367881",
      appId: "1:1017456367881:web:5c664f4ec295407296dbd8",
    ),
  );
    ...
    return MaterialApp(
      ...
      onGenerateRoute: (settings) {
        ...
        if (settings.name == '/signup-details') {
          final args = settings.arguments as Map<String, dynamic>? ?? {};
          return MaterialPageRoute(
             builder: (context) => SignupDetailsScreen(role: args['role'] ?? 'regular'),
          );
        }
      ...
      routes: {
        ...
        '/maternity': (context) => const MaternityScreen(),
      },
    );
  }
}
