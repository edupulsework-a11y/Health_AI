#import "include/stream_webrtc_flutter/FlutterRTCAudioSink.h"
#import <AVFoundation/AVFoundation.h>
#include "audio_sink_bridge.cpp"
#import "include/stream_webrtc_flutter/RTCAudioSource+Private.h"
#include "include/stream_webrtc_flutter/media_stream_interface.h"
...
void RTCAudioSinkCallback(void* object,
  ...
  CMAudioFormatDescriptionCreate(kCFAllocatorDefault, &audioDescription, 0, nil, 0, nil, nil,
                                 &formatDesc);
  ...
  CMSampleBufferCreate(kCFAllocatorDefault, nil, false, nil, nil, formatDesc,
                       number_of_frames * number_of_channels, 1, &timing, 0, nil, &buffer);
  CMSampleBufferSetDataBufferFromAudioBufferList(buffer, kCFAllocatorDefault, kCFAllocatorDefault,
                                                 0, &audioBufferList);
  @autoreleasepool {
