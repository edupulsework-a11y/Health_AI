...
- (void)mediaStreamTrackSetFocusPoint:(nonnull RTCMediaStreamTrack*)track
  ...
  if (!device.isFocusPointOfInterestSupported) {
    ...
    result([FlutterError errorWithCode:@"mediaStreamTrackSetFocusPointFailed"
                               message:@"Focus point of interest is not supported"
                               details:nil]);
    return;
  }
  ...
  [device setFocusPointOfInterest:[self getCGPointForCoordsWithOrientation:orientation x:x y:y]];
  [device unlockForConfiguration];
...
- (void)mediaStreamTrackSetExposurePoint:(nonnull RTCMediaStreamTrack*)track
  ...
  if (!device.isExposurePointOfInterestSupported) {
    ...
    result([FlutterError errorWithCode:@"mediaStreamTrackSetExposurePointFailed"
                               message:@"Exposure point of interest is not supported"
                               details:nil]);
    return;
  }
  UIDeviceOrientation orientation = [[UIDevice currentDevice] orientation];
  [device lockForConfiguration:nil];
  [device setExposurePointOfInterest:[self getCGPointForCoordsWithOrientation:orientation x:x y:y]];
  [device unlockForConfiguration];
